...
func (in *VdpaConfig) DeepCopyInto(out *VdpaConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VdpaConfig.
func (in *VdpaConfig) DeepCopy() *VdpaConfig {
	if in == nil {
		return nil
	}
	out := new(VdpaConfig)
